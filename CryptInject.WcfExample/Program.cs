...
namespace CryptInject.WcfExample
{
    class Program
    {
        private const string Url = "http://localhost:8085/CryptInjectWcf";
        ...
        static void Main(string[] args)
        {
            ...
            svcHost.Description.Behaviors.Add(new ServiceDebugBehavior { IncludeExceptionDetailInFaults = true });
